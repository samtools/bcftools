...
static void usage(args_t *args)
{
    ...
    fprintf(stderr, "   -g, --GQ-threshold <float>      minimum GQ of constrained trio genotypes, otherwise use unconstrained GT [10]\n");
...
int main_vcfcall(int argc, char *argv[])
{
	...
	while ((c = getopt_long(argc, argv, "h?o:r:s:t:ANS:vcmp:C:XYg:", loptions, NULL)) >= 0) 
    {
		switch (c) 
        {
            ...
            case 'g': args.aux.CGQ_th = atof(optarg); break;
